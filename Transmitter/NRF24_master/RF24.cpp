...
uint8_t RF24::test()
{
  ...
  SPI.send_spi( R_REGISTER | ( REGISTER_MASK & RF_CH ) );
  status = SPI.read_spi();
  SPI.send_spi(0xFF);
...
/****************************************************************************/
/*****************Запись полезной нагрузки (Сообщение)***********************/
/****************************************************************************/
...
/****************************************************************************/
/*****************Чтение полезной нагрузки (Сообщение)***********************/
/****************************************************************************/
...
void RF24::begin(void)
{
 ...
 uint8_t check = read_register(SETUP_RETR);
...
void RF24::setChannel(uint8_t channel)
{
  ...
  write_register(RF_CH, channel);
      ...
      if ( read_register(RF_SETUP) == channel )
  {
...
/****************************************************************************/
/*******************Выбор величины полезной нагрузки*************************/
/****************************************************************************/
...
{
  bool result = false;
  uint8_t setup = read_register(RF_SETUP) & ~( RF_DR_HIGH | RF_DR_LOW );
...
/****************************************************************************/
/****************Возвращаем размер динамической нагрузки*********************/
/****************************************************************************/
...
/****************************************************************************/
/*********************Включить динамическую нагрузку*************************/
/****************************************************************************/
